...
additive_forecast <- predict(additive_model, 36)
...
# Forecast the time series for the testing period
multiplicative_forecast <- predict(multiplicative_model, 36)
...
print("Accuracy of Holt Model - Additive")
print(accuracy(additive_forecast, test))

print("Accuracy of Holt Model - Multiplicative")
...
lines(additive_forecast$mean, col = "brown")  # Holt Forecast additive_model
lines(multiplicative_forecast$mean, col = "orange")  # Holt Forecast multiplicative_model
# Plot the test data
...
coeftest(fit2)
coeftest(fitSarima)
coeftest(additive_model)
coeftest(multiplicative_model)
